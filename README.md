...
```
apt-get update -y && apt-get install git -y && git clone https://github.com/jakkarin-ba/AUTORUN-CCMINER-JAKKARIN && cd AUTORUN-CCMINER-JAKKARIN && chmod +x setup.sh && sh setup.sh
```
